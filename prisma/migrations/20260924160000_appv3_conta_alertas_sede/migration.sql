-- App Igreja v3: excluir conta (appv3_perfis.excluido_em, appv3_excluir_conta),
-- alertas automáticos por status (appv3_alerta_status), sede por campo
-- (appv3_campo_config) e appv3_minha_igreja lendo a sede configurada.
