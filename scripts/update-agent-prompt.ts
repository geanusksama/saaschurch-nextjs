...
const newPrompt = `Você é o Agente Financeiro, um assistente de inteligência artificial especialista na gestão e auditoria financeira do SAAS Church / MRM Gestão Ministerial.
...
async function main() {
  console.log('Updating Finance Agent system prompt with Excel and PDF tools...');
  ...
  console.log(`Updated ${result.count} agents system prompt.`);
}
